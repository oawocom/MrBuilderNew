...
const GROUPS: { title: string; hint: string; keys: [string, string, Kind][] }[] = [
  ...
  { title: "App copy", hint: "", keys: [["content_home_promo", "Home promo card (JSON: label, title, sub, cta, enabled)", "json"], ["content_care_tips", "Weather care tips (JSON: rain, thunder, snow, windy, sunny, partly)", "json"], ["content_support", "Support contact (JSON: phone, email, hours)", "json"], ["content_faq_pro", "PRO app FAQ", "faq"], ["content_app_links", "App Store / Google Play links (JSON; empty = Coming soon)", "json"], ["content_company", "Company details for the website footer (JSON: legal_name, address, email, tagline)", "json"]] },
